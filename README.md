...
```typescript
import { OAuth2Client } from "@trimble-quest/capacitor-oauth2";
...
| parameter                    | default | required | description                                                                                                              | since |
| ---------------------------- | ------- | -------- | ------------------------------------------------------------------------------------------------------------------------ | ----- |
| customHandlerClass           |         |          | Provide a class name implementing `com.trimble-quest.capacitor.oauth2.handler.OAuth2CustomHandler`                       |       |
...
| parameter          | default | required | description                                                                                    | since |
| ------------------ | ------- | -------- | ---------------------------------------------------------------------------------------------- | ----- |
| customHandlerClass |         |          | Provide a class name implementing `TrimbleQuestCapacitorOauth2.OAuth2CustomHandler`            |       |
...
This class has to implement `TrimbleQuestCapacitorOauth2.OAuth2CustomHandler`.
    ...
    async ngOnInit() {
        ...
        if (this.ios) {
            const majorVersion: number =
                +this.deviceInfo.osVersion.split(".")[0];
...
import {
    ...
    OAuth2Client,
} from "@trimble-quest/capacitor-oauth2";
...
export class AuthService {
    getAzureB2cOAuth2Options(): OAuth2AuthenticateOptions {
        return {
            ...
            android: {
                redirectUrl:
                    "msauth://{package-name}/{url-encoded-signature-hash}", // See Azure Portal -> Authentication -> Android Configuration "Redirect URI"
            },
            ios: {
...
import com.trimble-quest.capacitor.oauth2.handler.AccessTokenCallback;
import com.trimble-quest.capacitor.oauth2.handler.OAuth2CustomHandler;
...
def capacitor_pods
  ...
  pod 'TrimbleQuestCapacitorOauth2', :path => '../../node_modules/@trimble-quest/capacitor-oauth2'
  # core plugins
...
import Capacitor
import TrimbleQuestCapacitorOauth2
